                ...
                <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="bg-gray-800 rounded-lg shadow-lg p-6 h-[700px] overflow-y-auto scrollbar-hide">
                            ...
                            />
                            <p>Untuk membeli anda hanya perlu:</p>
                            ...
                            <p>
                                Dengan begitu anda selesai melakukan pembelian
                            </p>
                        </div>
                                ...
                                {name.map((product, index) => (
                                    <div
                                        ...
                                        onClick={() => {
                                            ...
                                            setSelectedProduct(
                                                `hai, saya ingin ingin membeli ${product.name} dengan varian ${product.variant} seharga ${product.price}`
                                            );
